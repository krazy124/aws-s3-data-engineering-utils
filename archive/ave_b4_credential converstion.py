...
def upload_folder(
    ...
    If include_root_folder is False:
        local_folder/file.csv -> folder_name/file.csv

    If include_root_folder is True:
        local_folder/file.csv -> folder_name/local_folder/file.csv
    """
    if not folder_name.endswith("/"):
        folder_name += "/"

    if include_root_folder:
        root_folder_name = os.path.basename(
            os.path.normpath(local_folder_path))
        folder_name = f"{folder_name}{root_folder_name}/"
